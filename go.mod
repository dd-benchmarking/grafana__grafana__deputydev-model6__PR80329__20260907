...
require (
	...
	github.com/prometheus/client_golang v1.24.1 // @grafana/alerting-squad-backend
	...
	golang.org/x/exp v0.0.0-20240823005443-9b4947da3948 // @grafana/alerting-squad-backend
